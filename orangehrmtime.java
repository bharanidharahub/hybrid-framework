...
public class orangehrmtime {
	...
	@FindBy(xpath = "(//div[.='9'])[1]/../div[15]")
	private WebElement afterdateonin; 

	@FindBy(xpath = "(//div[.='17'])[2]")
	...
	//verify the calendar clear button in punch OUT  page
